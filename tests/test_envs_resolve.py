...
class TestResolveVersion:
    ...
    def test_editable_loses_to_numbered_when_unpinned(self):
        """An editable slot is opt-in: it sorts below every numbered
        version so that linking a checkout doesn't change what every
        directory on the machine serves. Covered in full, across all
        three surfaces, in test_editable_resolution.py."""
